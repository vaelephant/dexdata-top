      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300">
            Every person or enterprise with data can earn income from their own
            data Every person or enterprise with computing power can earn income
            from their own computing power <br></br>Artificial intelligence is becoming
            better with the help of blockchain
          </p>
        </div>
